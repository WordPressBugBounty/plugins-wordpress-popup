...
return array(
    ...
    'Hustle_Auth_Provider' => $baseDir . '/inc/interface-hustle-auth-provider.php',
    'Hustle_Auth_Token' => $baseDir . '/inc/class-hustle-auth-token.php',
    ...
    'Hustle_ConstantContact_API_V2_Non_Hub' => $baseDir . '/inc/providers/constantcontact/hustle-constantcontact-api-v2-non-hub.php',
    'Hustle_ConstantContact_AccountInfo' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/account/hustle-constantcontact-account-info.php',
    'Hustle_ConstantContact_Api' => $baseDir . '/inc/providers/constantcontact/hustle-constantcontact-api.php',
    'Hustle_ConstantContact_Api_Interface' => $baseDir . '/inc/providers/constantcontact/hustle-constantcontact-api-interface.php',
    'Hustle_ConstantContact_Api_V2' => $baseDir . '/inc/providers/constantcontact/hustle-constantcontact-api-v2.php',
    'Hustle_ConstantContact_Base_Model' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/hustle-constantcontact-base-model.php',
    'Hustle_ConstantContact_CompanyLogo' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/account/hustle-constantcontact-company-logo.php',
    'Hustle_ConstantContact_Contact' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-contact.php',
    'Hustle_ConstantContact_ContactsList' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/hustle-constantcontact-contactslist.php',
    'Hustle_ConstantContact_ContactsResponse' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-contacts-response.php',
    'Hustle_ConstantContact_CustomField' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-custom-field.php',
    'Hustle_ConstantContact_EmailAddress' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-email-address.php',
    ...
    'Hustle_ConstantContact_Note' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-note.php',
    'Hustle_ConstantContact_OAuth' => $baseDir . '/inc/providers/constantcontact/hustle-constantcontact-oauth.php',
    'Hustle_ConstantContact_PhoneNumber' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-phone-number.php',
    'Hustle_ConstantContact_PhysicalAddress' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/account/hustle-constantcontact-address.php',
    'Hustle_ConstantContact_SmsChannel' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-sms-channel.php',
    'Hustle_ConstantContact_SmsConsent' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-sms-consent.php',
    'Hustle_ConstantContact_StreetAddress' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/contact/hustle-constantcontact-street-address.php',
    'Hustle_ConstantContact_Updatable_Model' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/models/hustle-constantcontact-updatable-model.php',
    'Hustle_Contact_API_V3_Client' => $baseDir . '/inc/providers/constantcontact/constantcontactv3/hustle-constantcontact-api-v3-client.php',
    ...
    'Hustle_Infusion_Soft_Custom_Field' => $baseDir . '/inc/providers/infusionsoft/model/hustle-infusion-soft-custom-field.php',
    'Hustle_Infusion_Soft_Form_Settings' => $baseDir . '/inc/providers/infusionsoft/hustle-infusion-soft-form-settings.php',
    'Hustle_Infusion_Soft_OAuth' => $baseDir . '/inc/providers/infusionsoft/hustle-infusion-soft-oauth.php',
    'Hustle_Infusion_Soft_OAuth_Non_Hub' => $baseDir . '/inc/providers/infusionsoft/hustle-infusion-soft-oauth-non-hub.php',
    ...
    'Opt_In' => $baseDir . '/inc/class-opt-in.php',
    ...
    'Opt_In_Infusionsoft_Connection' => $baseDir . '/inc/providers/infusionsoft/interface-opt-in-infusionsoft-connection.php',
    'Opt_In_Infusionsoft_Contact' => $baseDir . '/inc/providers/infusionsoft/model/hustle-infusion-soft-contact.php',
    'Opt_In_Infusionsoft_Request_Method' => $baseDir . '/inc/providers/infusionsoft/hustle-infusion-soft-request-method.php',
    'Opt_In_Infusionsoft_Rest_Api' => $baseDir . '/inc/providers/infusionsoft/hustle-infusion-soft-rest-api.php',
